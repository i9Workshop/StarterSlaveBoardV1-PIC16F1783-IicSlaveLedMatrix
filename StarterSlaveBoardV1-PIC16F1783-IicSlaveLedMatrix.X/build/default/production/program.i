...
void programLoop(void) {
    ledMatrix_SetDisplay(i2c_RxData);
}
...
void ledMatrix_DelayScanInput(uint16_t delay) {
    for(uint16_t i=0; i<delay; i++) {
        ...
        i2c_TxData = (uint8_t)((PORTBbits.RB1 << 5) | (PORTBbits.RB0 << 4) | (PORTBbits.RB5 << 3) |
                     (PORTBbits.RB4 << 2) | (PORTBbits.RB3 << 1) | PORTBbits.RB2);
    }
}
